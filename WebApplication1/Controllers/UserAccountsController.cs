...
//   [AllowAnonymous]
    public class UserAccountsController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            IdentityResult passwordChangeResult =  UserManager.ResetPassword(user.Id, resetToken, model.NewPassword);
            if (!passwordChangeResult.Succeeded)
            {
                ViewBag.Message = " Passwords must have at least one non letter or digit character.Passwords must have at least one digit('0' - '9').Passwords must have at least one uppercase('A' - 'Z').";
                return View("ChangePassword", new ChangePasswordViewModel());
            }
